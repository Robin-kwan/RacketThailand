...
const LANDING_SEO = {
  th: {
    ...
    keywords: [
      ...
      "หากลุ่มเล่นพาเดล",
      "หาเพื่อนเล่นพาเดล",
      "หากลุ่มเล่นพิคเคิลบอล",
      "หาเพื่อนเล่นพิคเคิลบอล",
      "หากลุ่มตีปิงปอง",
      "หาเพื่อนตีปิงปอง",
      "คอมมูนิตี้กีฬา",
      "กีฬาแร็กเกต",
  ...
  en: {
    ...
    description:
      "A platform for finding racket sport courts, partners, player groups, activities, and communities across Thailand, covering badminton, tennis, padel, pickleball, and table tennis.",
    keywords: [
      ...
      "find badminton groups",
      "tennis group Bangkok",
      "find tennis partners",
      "find tennis groups",
      "find padel partners",
      "find padel groups",
      "find pickleball partners",
      "find pickleball groups",
      "find table tennis partners",
      "find table tennis groups",
