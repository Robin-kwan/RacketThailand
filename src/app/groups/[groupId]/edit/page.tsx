...
export default async function EditGroupPage({
  ...
  const copy = {
    ...
    wizardStepBasic: t("groups.form.wizardStepBasic"),
    wizardStepCourts: t("groups.form.wizardStepCourts"),
    wizardStepContact: t("groups.form.wizardStepContact"),
    wizardStepPhotos: t("groups.form.wizardStepPhotos"),
    wizardNext: t("groups.form.wizardNext"),
    wizardBack: t("groups.form.wizardBack"),
    wizardRequiredFields: t("groups.form.wizardRequiredFields"),
    ...
    courtSportMismatch: t("groups.form.courtSportMismatch"),
