# Facebook Pickleball Group Preview Workflow

Source group:

- https://www.facebook.com/groups/465849552420177
...
- `.codex/facebook-pickleball-group-preview/runs/YYYY-MM-DD/preview.json`
- `.codex/facebook-pickleball-group-preview/runs/YYYY-MM-DD/images/`
- `.codex/facebook-pickleball-group-preview/runs/YYYY-MM-DD/raw/`

Goal:

- Find public pickleball group-ad posts in the source Facebook group.
