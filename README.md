...
- `/[sport]/players`: Public player discovery and one-off play invitations.
- `/[sport]/casual-plays`: Legacy redirect to the play-invitations view.
...
- `/casual-plays/create`: Authenticated one-off play invitation form.
